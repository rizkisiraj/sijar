          ...
          <Layout title="Home" logoPath="/home-ico.png">
            ...
            <section className="my-4 text-gray-200 text-base leading-8">
              ...
              <div className="my-6 flex flex-wrap gap-2">
                <ProjectCard id="mealminder" name="MealMinder" stack={"Mobile App"} />
                <ProjectCard id="go-english" name="GoEnglish" stack={"Mobile App"} />
              </div>
              ...
              <p>If you&apos;re interested on knowing more of my works, you can contact me through <a className="underline decoration-wavy text-white" href="https://www.linkedin.com/in/rizki-siraj/">Linkedin</a> and email.</p>
            </section>
            </div>
          </Layout>
  );
