...
export default function Post(props:Props) {
  ...
  return (
    ...
    <div className="font-sans">
      ...
      <div className="prose-lg prose-code:bg-inherit prose-h2:font-semibold prose-h2:text-2xl prose-h2:text-neutral-300 prose-code:text-neutral-300 prose-pre:bg-gray-700 prose-p:text-neutral-300 mt-12 prose-code:text-sm prose-pre:max-w-full prose-pre:overflow-x-auto prose-li:text-neutral-300 prose-ul:list-disc">
